...
struct Config {
    ...
    static constexpr double rainAddedMoistureMin = 28.95; // 300mm - 10.5 mm = record flood - daily water gain
    ...
    //gravel
    static constexpr double graveltFC = 18.21; // field capacity = max % moisture cell can hold
